...
function FlyingPhoto({ photo }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => setFly(true), 50);
...
function QuantumCard({ visible }) {
  ...
  const [flyQueue, setFlyQueue] = useState(() => shuffle(ALL_PHOTOS));

  useEffect(() => {
    if (!active) {
      setFlying([]);
      setFlyQueue(shuffle(ALL_PHOTOS));
      return;
    }
  ...
  return (
    <div
      ...
      style={{
        height: 520, borderRadius: 28, overflow: active ? 'visible' : 'hidden',
    ...
    >
      ...
      <div style={{
        ...
        {!active ? (
          <>
            ...
            <h3 style={{
              fontSize: 'clamp(1.4rem,4vw,2.2rem)', fontWeight: 900, fontStyle: 'italic',
          ...
          <div style={{
            background: 'rgba(7,0,14,0.7)', backdropFilter: 'blur(8px)',
            border: '1px solid rgba(0,220,80,0.4)', borderRadius: 100,
            padding: '10px 20px', textAlign: 'center',
            boxShadow: '0 0 20px rgba(0,220,80,0.3)',
            animation: 'pulse-glow 2s infinite'
          }}>
            <p style={{
              fontSize: 10, fontFamily: 'monospace', fontWeight: 700,
              letterSpacing: '0.2em', color: 'rgba(0,220,80,0.9)', margin: 0
            }}>
              CERRAR PORTAL
            </p>
          </div>
      ...
      {/* ── Fireworks overlay ── */}
      {active && (
        <div style={{ position: 'absolute', top: '50%', left: '50%', width: 0, height: 0, zIndex: 9999 }}>
          {flying.map(f => <FlyingPhoto key={f.id} photo={f.photo} />)}
        </div>
      )}
    </div>
  );
...
export default function RevealScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#07000e', color: '#f5e6c8', overflowX: 'hidden' }}>
      ...
      <div className="relative overflow-hidden" style={{
        ...
        <div style={{
          ...
          <p style={{
            fontSize: 'clamp(1rem,2.5vw,1.3rem)', fontWeight: 300, lineHeight: 1.7,
            color: 'rgba(245,230,200,0.7)', maxWidth: 560, margin: '0 auto'
          }}>
            Has demostrado que cada momento que hemos vivido vive también en ti.
            <br /><br />
            El universo ha respondido:
        ...
        <div style={{ display: 'grid', gap: 20, gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: 20, marginBottom: 32 }}>
              <div>
                <p style={{
                  fontSize: 10, fontFamily: 'system-ui', fontWeight: 700, letterSpacing: '0.3em',
                  textTransform: 'uppercase', color: '#d4a853', marginBottom: 8
                }}>Tu Experiencia de Vida</p>
                <h2 style={{
                  fontSize: 'clamp(1.8rem,5vw,2.8rem)', fontWeight: 900, lineHeight: 1.1,
                  color: '#f5e6c8', fontStyle: 'italic'
                }}>Denver:<br />Week Long Retreat</h2>
              </div>
              <div style={{
                background: 'linear-gradient(135deg,#d4a853,#c4687a)',
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 2, padding: '48px 40px 32px', textAlign: 'center' }}>
              ...
              <h3 style={{
                fontSize: 'clamp(2.2rem,7vw,4rem)', fontWeight: 900, fontStyle: 'italic',
            ...
            <div style={{ position: 'relative', zIndex: 2, margin: '0 28px 0' }}>
              ...
              <div style={{
                ...
                <p style={{
                  fontSize: 12, fontFamily: 'system-ui', fontWeight: 700, color: '#93c5fd',
                  letterSpacing: '0.2em', textTransform: 'uppercase'
                }}>One Ski Hill Place</p>
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div>
                    <p style={{
                      fontSize: 10, fontFamily: 'system-ui', fontWeight: 700,
                      letterSpacing: '0.2em', textTransform: 'uppercase',
                      color: 'rgba(147,197,253,0.5)', marginBottom: 2
                    }}>{item.label}</p>
          ...
          <div style={{ gridColumn: '1 / -1', display: 'flex', gap: 20, flexWrap: 'wrap', alignItems: 'stretch' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  fontSize: 'clamp(0.95rem,2.5vw,1.05rem)', fontWeight: 300, lineHeight: 1.85,
              ...
              <div style={{ borderTop: '1px solid rgba(212,168,83,0.15)', paddingTop: 20 }}>
                ...
                <p style={{
                  fontSize: 10, fontFamily: 'system-ui', letterSpacing: '0.25em',
          ...
          <div style={{
            ...
            <Star style={{
              width: 20, height: 20, color: '#d4a853', fill: '#d4a853',
          ...
          <div style={{
            ...
            <a
              href="https://drjoedispenza.com/login"
              target="_blank"
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 15px 40px rgba(212,168,83,0.4)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 10px 30px rgba(212,168,83,0.3)';
              }}
            >
              Ir a tu dashboard de Joe Dispenza <span style={{ fontSize: 18 }}>→</span>
            </a>
            <div style={{
              marginTop: 16,
              ...
              <p style={{
                ...
                color: 'rgba(245,230,200,0.6)', margin: 0, lineHeight: 1.6
              }}>
                Correo de acceso: <span style={{ color: '#d4a853' }}>libreyloco72@gmail.com</span><br />
                <span style={{ fontSize: 9, color: 'rgba(245,230,200,0.4)' }}>(Accede como cuenta de Google en la parte inferior del recuadro de acceso)</span>
              </p>
            </div>
          </div>
